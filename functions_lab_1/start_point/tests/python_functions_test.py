...
#   @unittest.skip("delete this line to run the test")
  ...
  @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self, number):
    cube = number * number * number
    return cube

  #Given a String, return the String reversed
#   @unittest.skip("delete this line to run the test")
  def test_reverse_string(self, text):
    reverse_string = text[-1::-1]
    return reverse_string

  #Given a value in farenheit, convert this into celsius.
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self, convertion):
    celsius = (convertion - 32) * (5/9)
    return celsius
